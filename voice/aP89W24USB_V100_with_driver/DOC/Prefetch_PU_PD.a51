...
; To demostrate the CPU Serial Command Mode using 8951 CPU
; Command sequency - Prefetch > PUP2 > PDN2
;==========================================================================
...
Sec00:             nop
                   ...
                   call  Sound_Cmd
                   clr   _Snd_CS
Wait00:   	   mov   C,_Snd_Full            ; Wait unit FULL becomes HIHG
                   jnc   Wait00                 ; FULL = HIHG => PREFETCH finished                       
                   mov   C,_Snd_Full
                   jnc   Wait00
...
Wait01:            mov   C,_Snd_Full             ; Wait unit FULL becomes LOW
                   jc    Wait01                  ; FULL = LOW => Voice playback begin
                   mov   C,_Snd_Full
                   jc    Wait01


WaitBusy:          mov   C,_Snd_Busy             ; Wait unit BUSY becomes LOW
                   jc    WaitBusy                ; BUSY = LOW => End of playback
                   mov   C,_Snd_Busy
                   jc    WaitBusy
